...
set Library     "hls"
set IPName      "math_accel"
set Version     "1.0"
set DisplayName "Math_accel"
set Revision    "1609042049"
...
set Interfaces {
    s_axi_control_intr {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_control_intr"
        param_prefix "C_S_AXI_CONTROL_INTR"
        addr_bits "4"
    ...
    ap_clk {
        ...
        buses "s_axi_control_intr in_stream out_stream"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 20.000000 machine 64 combinational 0 latency 20 II x}
...
set enable_xo_gen 0
set kernel_files {/opt/Xilinx/Projects/visual_equalizer/math_accel/solution1/math_accel.cpp}
if {$enable_xo_gen} {
