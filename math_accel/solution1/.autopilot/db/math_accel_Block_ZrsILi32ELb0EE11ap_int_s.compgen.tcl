...
set id 1
set name math_accel_uitodp_32s_64_3
...
set id 2
set name math_accel_dsqrt_64ns_64ns_64_17
...
set id 3
set name math_accel_mac_muladd_16s_16s_32s_32_1
...
set out_width 32
set exp i0*i1+i2
set arg_lists {i0 {16 1 +} i1 {16 1 +} m {32 1 +} i2 {32 1 +} p {32 1 +} c_reg {1} }
if {${::AESL::PGuard_simmodel_gen}} {
...
set id 4
set name math_accel_mul_mul_16s_16s_32_1
...
set out_width 32
set exp i0*i1
set arg_lists {i0 {16 1 +} i1 {16 1 +} p {32 1 +} }
if {${::AESL::PGuard_simmodel_gen}} {
...
eval "cg_default_interface_gen_dc { \
    id 12 \
    name tmp_last_V_2_out_out \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_tmp_last_V_2_out_out \
    op interface \
    ports { tmp_last_V_2_out_out_din { O 1 vector } tmp_last_V_2_out_out_full_n { I 1 bit } tmp_last_V_2_out_out_write { O 1 bit } } \
} "
}
