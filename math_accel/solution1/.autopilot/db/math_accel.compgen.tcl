...
# FIFO definition:
set ID 24
set FifoName FIFO_math_accel_tmp_last_V_2_loc_channel
...
# FIFO definition:
set ID 25
set FifoName FIFO_math_accel_tmp_4_loc_channel
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 26
set FifoName FIFO_math_accel_p_channel
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 27 \
			corename math_accel_control_intr_axilite \
			name math_accel_control_intr_s_axi \
			ports {$port_control_intr} \
			op interface \
		} "
	} else {
		puts "@W \[IMPL-110\] Cannot find AXI Lite interface model in the library. Ignored generation of AXI Lite  interface for 'control_intr'"
	}
}

if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler math_accel_control_intr_s_axi
}
