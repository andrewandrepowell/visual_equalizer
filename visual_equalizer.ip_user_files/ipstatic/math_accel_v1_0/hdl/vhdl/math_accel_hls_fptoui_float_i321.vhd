...
entity math_accel_hls_fptoui_float_i321 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of math_accel_hls_fptoui_float_i321 is 
    ...
    signal p_Val2_s_fu_45_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal loc_V_1_fu_59_p1 : STD_LOGIC_VECTOR (22 downto 0);
    signal p_Result_s_fu_63_p3 : STD_LOGIC_VECTOR (23 downto 0);
    signal loc_V_fu_49_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_i_i_cast_fu_75_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal sh_assign_fu_79_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_i_fu_93_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal isNeg_fu_85_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_i_cast_fu_99_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal sh_assign_1_fu_103_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal sh_assign_1_i_cast_cast_fu_115_p1 : STD_LOGIC_VECTOR (23 downto 0);
    signal sh_assign_1_i_cast_fu_111_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_8_i_cast_fu_71_p1 : STD_LOGIC_VECTOR (54 downto 0);
    signal tmp_3_i_cast_fu_125_p1 : STD_LOGIC_VECTOR (54 downto 0);
    signal tmp_2_i_fu_119_p2 : STD_LOGIC_VECTOR (23 downto 0);
    signal tmp_fu_135_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_4_i_fu_129_p2 : STD_LOGIC_VECTOR (54 downto 0);
...
begin
    ...
    isNeg_fu_85_p3 <= sh_assign_fu_79_p2(8 downto 8);
    loc_V_1_fu_59_p1 <= p_Val2_s_fu_45_p1(23 - 1 downto 0);
    loc_V_fu_49_p4 <= p_Val2_s_fu_45_p1(30 downto 23);
    ...
    sh_assign_1_fu_103_p3 <= 
        tmp_i_cast_fu_99_p1 when (isNeg_fu_85_p3(0) = '1') else 
        sh_assign_fu_79_p2;
        sh_assign_1_i_cast_cast_fu_115_p1 <= std_logic_vector(resize(signed(sh_assign_1_fu_103_p3),24));

        sh_assign_1_i_cast_fu_111_p1 <= std_logic_vector(resize(signed(sh_assign_1_fu_103_p3),32));

    sh_assign_fu_79_p2 <= std_logic_vector(signed(ap_const_lv9_181) + signed(tmp_i_i_cast_fu_75_p1));
    tmp_1_fu_143_p1 <= std_logic_vector(resize(unsigned(tmp_fu_135_p3),32));
    tmp_2_fu_147_p4 <= tmp_4_i_fu_129_p2(54 downto 23);
    tmp_2_i_fu_119_p2 <= std_logic_vector(shift_right(unsigned(p_Result_s_fu_63_p3),to_integer(unsigned('0' & sh_assign_1_i_cast_cast_fu_115_p1(24-1 downto 0)))));
    tmp_3_i_cast_fu_125_p1 <= std_logic_vector(resize(unsigned(sh_assign_1_i_cast_fu_111_p1),55));
    tmp_4_i_fu_129_p2 <= std_logic_vector(shift_left(unsigned(tmp_8_i_cast_fu_71_p1),to_integer(unsigned('0' & tmp_3_i_cast_fu_125_p1(31-1 downto 0)))));
    tmp_8_i_cast_fu_71_p1 <= std_logic_vector(resize(unsigned(p_Result_s_fu_63_p3),55));
    tmp_fu_135_p3 <= tmp_2_i_fu_119_p2(23 downto 23);
        tmp_i_cast_fu_99_p1 <= std_logic_vector(resize(signed(tmp_i_fu_93_p2),9));

    tmp_i_fu_93_p2 <= std_logic_vector(unsigned(ap_const_lv8_7F) - unsigned(loc_V_fu_49_p4));
    tmp_i_i_cast_fu_75_p1 <= std_logic_vector(resize(unsigned(loc_V_fu_49_p4),9));
end behav;
