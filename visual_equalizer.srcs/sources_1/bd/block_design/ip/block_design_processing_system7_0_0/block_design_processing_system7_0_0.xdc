...
# Clock constraints                                                        #
############################################################################
create_clock -name clk_fpga_3 -period "6.666" [get_pins "PS7_i/FCLKCLK[3]"]
set_input_jitter clk_fpga_3 0.19998
#The clocks are asynchronous, user should constrain them appropriately.#
create_clock -name clk_fpga_2 -period "20" [get_pins "PS7_i/FCLKCLK[2]"]
set_input_jitter clk_fpga_2 0.6
#The clocks are asynchronous, user should constrain them appropriately.#
create_clock -name clk_fpga_1 -period "80.952" [get_pins "PS7_i/FCLKCLK[1]"]
set_input_jitter clk_fpga_1 2.42856
#The clocks are asynchronous, user should constrain them appropriately.#
